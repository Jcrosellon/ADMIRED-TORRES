	...
	<body>
		...
		<main class="main-content">
			...
			<section class="container top-products">
				<h1 class="heading-1">Mejores Arriendos</h1>
				...
				<div class="container-products">
					...
					<div class="card-product">
						<div class="container-img">
							<img src="./assets/imagenes/apartemento1.jpg" alt="Cafe Irish" />
						...
						<div class="content-card-product">
							...
							<p class="price">$500.000<span>$3000.000</span></p>
							<p>Arriendo Por mes inluyedo la administración, Los servicios son aprte</p>
						</div>
					</div>
					<!-- Producto 2 -->
					<div class="card-product">
			...
			<section class="container blogs">
				...
				<div class="container-blogs">
					...
					<div class="card-blog">
						<div class="container-img">
							<img src="./assets/imagenes/blog-3.jpg" alt="Imagen Blog 3" />
							<div class="button-group-blog">
								<span>
									<i class="fa-solid fa-magnifying-glass"></i>
								</span>
